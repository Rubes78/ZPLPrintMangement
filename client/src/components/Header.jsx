  ...
  return (
    <header className="flex items-center gap-2 bg-slate-900 border-b border-slate-700 px-3 py-2 shrink-0">
      ...
      <button onClick={onPrint}
        className="bg-blue-600 hover:bg-blue-500 text-white px-3 py-1 rounded text-sm font-medium shrink-0 transition-colors">
        Print
      </button>

      {/* Import & Print button */}
      <button onClick={onBatchPrint}
        className="bg-indigo-700 hover:bg-indigo-600 text-white px-3 py-1 rounded text-sm font-medium shrink-0 transition-colors flex items-center gap-1.5">
